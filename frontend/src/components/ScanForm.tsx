  ...
  const handleScan = async () => {
    ...
    try {
      const response = await fetch('http://localhost:8000/scan', {
        ...
        body: JSON.stringify({ url, exclude: excludeArray }),
      });
  ...
  <div className="container">
    <div className="form-section">
      ...
      <p className="instruction" style={{ marginTop: '1.5rem' }}>
        ...
        <span title="Verwende Pfade oder Platzhalter wie /blog/*, /shop/*, /hilfe.html">
          <HelpCircle size={16} style={{ cursor: "pointer", verticalAlign: "middle" }} />
        </span>
      </p>
      <input
        type="text"
